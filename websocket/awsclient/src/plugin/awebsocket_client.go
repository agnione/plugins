...
Objective     :   Implement the web socket client using gorilla/websocket library based on the IAWSClient interface
	...
	That will helps application units to implements it's features by using the framework support
...
// New creates a new instance of AWSClient and converts it into IZWSClient
//
// Returns the converted IAWSClient interface
...
// DeInitialize clear the instance values
